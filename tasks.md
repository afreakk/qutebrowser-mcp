...
- [ ] Add connection reuse to CDPClient.connectToTarget()
...
- [ ] Disconnect from closed tab in closeTarget()
...
- [ ] Make disconnect() consistent with connect() cleanup
...
- [ ] Improve duplicate URL error message in findTarget()
...
- [ ] Replace history.back() loop with Page.navigateToHistoryEntry for CDP back/forward
...
- [ ] Add truncation indicator to browser_fetch response
...
- [ ] Remove dead code path in IPC open() method
